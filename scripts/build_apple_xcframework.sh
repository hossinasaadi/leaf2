...
cargo build -p $package $release_flag --no-default-features --target x86_64-apple-darwin
cargo build -p $package $release_flag --no-default-features --target aarch64-apple-darwin
cargo build -p $package $release_flag --no-default-features --target aarch64-apple-ios
